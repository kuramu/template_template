$(function(){
	$(window).load(function(){
		var delaySpeed = 0;
		var fadeSpeed = 200;
		$('.pageNationGalleryNav').each(function(i){
...
jQuery.event.add(window, "load", function(){
	if($("#maincontent").size() > 0){
		var str = $("#maincontent").find(".left").find("img").attr("src").replace("_on.gif",".gif");
		str = $("#maincontent").find(".left").find("img").attr("src").replace(".gif","_first.gif");
		$("#maincontent").find(".left").find("img").attr("src", str);
		var str = $("#maincontent").find(".right").find("img").attr("src").replace("_on.gif",".gif");
		str = $("#maincontent").find(".right").find("img").attr("src").replace(".gif","_first.gif");
		$("#maincontent").find(".right").find("img").attr("src", str);

		var timer=window.setTimeout("rollbackMain()",500);
...
function rollbackMain(){
	var str = $("#maincontent").find(".left").find("img").attr("src").replace("_first","");
	$("#maincontent").find(".left").find("img").attr("src", str);
	var str = $("#maincontent").find(".right").find("img").attr("src").replace("_first","");
	$("#maincontent").find(".right").find("img").attr("src", str);
}
*/
$(document).ready(function(){
...
*/
		...
		for(var i = 0 ; i < _maxpage ; i++){
			var _pos = Math.round(854*(i-_currentpage)+$(window).width()/2-427);
			var _opa = 0.5;
...
/*
	$.fn.VogueRollOverMain = function() {
		...
		return this.hover(function(){
			...
			if(str.indexOf("_on")==-1 && str.indexOf("_nouse")==-1){
				str = str.replace(".gif","_on.gif");
				str= str.replace("_first.gif",".gif");
				str = str.replace(".jpg","_on.jpg");
				$(this).find("img").attr("src",str);
			}
		},function(){
